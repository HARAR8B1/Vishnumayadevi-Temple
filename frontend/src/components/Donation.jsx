...
export default function Donation() {
  ...
  const bannerImages = [
    ...
    { src: "/images/donation-banner-english.png", alt: "Temple Donation Appeal – English" },
  ];
    ...
    <section id="donation" className="py-16 sm:py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-xs sm:max-w-sm mx-auto">
          <div className="glass rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl relative overflow-hidden border-2 border-saffron/20 group">
              ...
              <div className="mb-5 w-full flex justify-center">
                <div className="p-3 sm:p-4 bg-white rounded-xl shadow-inner border border-gray-100 w-full">
                  <img
                    ...
                    className="w-full max-w-[200px] sm:max-w-[240px] h-auto mx-auto group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
              </div>
